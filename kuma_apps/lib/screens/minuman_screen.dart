        ...
        children: <Widget>[
          Stack(
            children: <Widget>[
              Container(
                ...
                child: Hero(
                  tag: widget.minuman.imageUrl,
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(30.0),
                    child: Image(
                      image: AssetImage(widget.minuman.imageUrl),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: widget.minuman.activitiesminum.length,
              itemBuilder: (BuildContext context, int index) {
                ActivityMinum activity = widget.minuman.activitiesminum[index];
                return Stack(
                  children: <Widget>[
                    Container(
